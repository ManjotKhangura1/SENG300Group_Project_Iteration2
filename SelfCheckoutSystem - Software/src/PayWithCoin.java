...
public class PayWithCoin {
		...
		/**
		 * PayWithCoin this is a constructor that sets up the instant variable for the class
		...
		/**
		 * Updates the coin slot whether a coin has been inserted
		 * adds it to the coin storage and updates the notesdeposited arraylist and totalPaid
